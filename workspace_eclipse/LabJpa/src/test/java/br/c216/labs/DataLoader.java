...
import br.c216.labs.service.FornecedorService;
...
//    @Test
    void load() {
        ...
        NotaCompraItem i1_2 = new NotaCompraItem(nc1, p2, new BigDecimal("1000.00"), 4);
        NotaCompraItem i1_3 = new NotaCompraItem(nc1, p3, new BigDecimal("500.00"), 5);
